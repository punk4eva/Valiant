...
public class SoundSystem{
    ...
    public static float sfxVolume = 5, musicVolume = 0;
    ...
    public void updateVolume(){
        if(currentLoop0) backgroundMusicLoop0.gainControl.setValue(musicVolume);
        else backgroundMusicLoop1.gainControl.setValue(musicVolume);
    }
    ...
    private static class MusicThread extends Thread implements LineListener{
        ...
        private void close(){
            playing = false;
            clip.close();
            if(loop0) Window.soundSystem.backgroundMusicLoop0 = null;
            else Window.soundSystem.backgroundMusicLoop1 = null;
        }
        ...
        public void run(){
            try{
                clip.start();
                if(fadingIn){
                    while(gainControl.getValue()<musicVolume){
